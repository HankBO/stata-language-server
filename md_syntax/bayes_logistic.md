...
| For a detailed description of `options`, see [<var class="command">Options</var><strong></strong>](logistic##options) in [<strong>[R]</strong> logistic](http://www.stata.com/help.cgi?logistic). |                   |                                                              |
