...
| For a detailed description of `options`, see [<var class="command">Options</var><strong></strong>](logit##options) in [<strong>[R]</strong> logit](http://www.stata.com/help.cgi?logit). |                   |                                                              |
