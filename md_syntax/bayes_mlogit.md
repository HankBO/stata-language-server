...
| For a detailed description of `options`, see [<var class="command">Options</var><strong></strong>](mlogit##options) in [<strong>[R]</strong> mlogit](http://www.stata.com/help.cgi?mlogit). |                   |                                                                                                                  |
