...
| For a detailed description of `options`, see [<var class="command">Options</var><strong></strong>](ologit##options) in [<strong>[R]</strong> ologit](http://www.stata.com/help.cgi?ologit). |                   |                                                              |
