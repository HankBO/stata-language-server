...
_\[`if`\] \[`in`\]_
\[[<var class="command">weight</var><strong></strong>](irt%20grm##weight)\]
\[`, options`\]
...
See
[<strong>[IRT]</strong> irt grm postestimation](http://www.stata.com/help.cgi?irt_grm_postestimation)
