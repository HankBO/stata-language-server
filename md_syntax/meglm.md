...
|              | `eform`                            | report exponentiated fixed-effects coefficients                                                                                                  |
...
| family |                                                                                                 | Description                                      |
|--------|-------------------------------------------------------------------------------------------------|--------------------------------------------------|
|        | `gaussian`                                                                                      | Gaussian (normal); the default                   |
|        | `bernoulli`                                                                                     | Bernoulli                                        |
...
[<strong>[BAYES]</strong> bayes: meglm](http://www.stata.com/help.cgi?bayes_meglm).
...
See
[<strong>[ME]</strong> meglm postestimation](http://www.stata.com/help.cgi?meglm_postestimation)
